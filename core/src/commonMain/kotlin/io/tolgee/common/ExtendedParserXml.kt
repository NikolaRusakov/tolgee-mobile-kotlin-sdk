...
///**
// * Reads an XML resource from an [java.io.InputStream] and delegates to [decodeAndroidXml].
// */
//fun decodeAndroidXmlStream(
//    stream: InputStream,
//    languageCode: String = "default",
//): List<TolgeeKey> =
//    decodeAndroidXml(stream.bufferedReader(Charsets.UTF_8).readText(), languageCode)
